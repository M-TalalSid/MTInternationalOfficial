  ...
  return (
    <div className="space-y-8 mb-20">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-blue-200">+92 (301) 021-9324</p>
              <p className="text-blue-200">+92 (334) 990-6990</p>
            </div>
          </div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl p-6 text-center">
        ...
        <p className="text-blue-100 mb-4">For Existing Clients With Critical Issues</p>
