  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {blogPosts.map((post) => (
        <article
          key={post.id}
          className="bg-blue-950/30 backdrop-blur-md rounded-2xl overflow-hidden border border-blue-500/20 hover:border-blue-400/40 transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-blue-500/10 group"
        >
          ...
          <div className="p-6">
            ...
            <h2 className="text-xl font-bold text-white mb-3 group-hover:text-blue-100 transition-colors duration-200">
              {post.title}
            </h2>

            <p className="text-blue-200 mb-4 line-clamp-3">{post.excerpt}</p>
            ...
            <div className="flex items-center justify-between">
              ...
              <Link
                href={`/blog/${post.slug}`}
                className="inline-flex items-center text-blue-400 group-hover:text-blue-300 transition-colors duration-200 font-medium"
              >
                Read More
