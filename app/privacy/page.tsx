            ...
            <div className="bg-blue-800/30 backdrop-blur-sm rounded-2xl p-8 border border-blue-700/50">
              <div className="prose prose-invert max-w-none">
                ...
                <p className="text-blue-200 mb-6">
                  We collect information you provide directly to us, such as when you contact us, request a quote, or
                  use our services.
                </p>
                ...
                <p className="text-blue-200 mb-6">
                  We use cookies and similar technologies to enhance your experience and analyze website usage. You can
                ...
                <p className="text-blue-200 mb-6">
                  If you have questions about this privacy policy, contact us at Info@mtinternationalofficial.com or +92
                  (301) 021-9324.
                </p>
