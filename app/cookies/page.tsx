          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-blue-800/30 backdrop-blur-sm rounded-2xl p-8 border border-blue-700/50">
              <div className="prose prose-invert max-w-none">
                ...
                <p className="text-blue-200 mb-6">
                  We use cookies to understand how you use our website, improve our services, and provide personalized
                ...
                <p className="text-blue-200 mb-6">
                  ...
                  cookies and they are subject to the third party's privacy policy.
                </p>
                ...
                <p className="text-blue-200 mb-6">
                  If you have questions about our use of cookies, contact us at mtinternational139@gmail.com or +92
                  (301) 021-9324.
                </p>
